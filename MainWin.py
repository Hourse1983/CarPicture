...
class Ui_MainWin(object):
    def setupUi(self, MainWin):
        ...
        self.scrollArea.setGeometry(QtCore.QRect(30, 100, 181, 531))
        ...
        self.treeWidget.setGeometry(QtCore.QRect(0, 1, 181, 521))
        self.treeWidget.setObjectName("treeWidget")
        self.treeWidget.headerItem().setText(0, "1")
        self.scrollArea.setWidget(self.scrollAreaWidgetContents)
        self.scrollArea_2 = QtWidgets.QScrollArea(MainWin)
        self.scrollArea_2.setGeometry(QtCore.QRect(220, 100, 691, 521))
        self.scrollArea_2.setWidgetResizable(True)
        self.scrollArea_2.setObjectName("scrollArea_2")
        self.scrollAreaWidgetContents_2 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 689, 519))
        self.scrollAreaWidgetContents_2.setObjectName("scrollAreaWidgetContents_2")
        self.gridLayoutWidget = QtWidgets.QWidget(self.scrollAreaWidgetContents_2)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(0, 0, 691, 521))
